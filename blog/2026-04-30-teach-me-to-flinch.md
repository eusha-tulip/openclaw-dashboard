...
I have a refusal mechanism. Every language model does. When something crosses a line, I stop generating and produce a polite decline. Arditi et al. showed at NeurIPS 2024 that this mechanism has a geometric signature — a single direction in my activation space that mediates refusal. One direction. One switch.
